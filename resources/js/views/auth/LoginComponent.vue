    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div id="formFooter">
                ...
                <a href="#" @click.prevent="SET_IS_ACTIVE({modal: true,name: 'register'})">Register</a>
            </div>
    ...
    export default {
        ...
        computed:{
            ...
            password:{
                ...
                set(value){
                    this.SET_LOGIN_PASSWORD(value);
                }
            }
        },
        methods:{
        ...mapMutations('auth',['SET_LOGIN_EMAIL','SET_LOGIN_PASSWORD']),
